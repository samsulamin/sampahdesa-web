    ...
    <div class="row">
        ...
        <div class="col-sm-11">
            <nav class="navbar navbar-expand-lg navbar-light bg-light" style="margin-top:20px">
                <a class="navbar-brand" href="{{url('/dashboard')}}"> DESA {{ Auth::user()->name}}</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/desadatapetugas')}}">
                                <i class='fas fa-database'></i> Data
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/desalaporan')}}">
                                <i class='fas fa-clipboard-list'></i> Laporan
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/desaabout')}}">
                                <i class='fas fa-info-circle'></i> About
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{url('/desanotifikasi')}}">
                                <i class='fas fa-bell'></i> Notifikasi
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="">
                                <i class='fas fa-city'></i> {{ Auth::user()->name}}
                            </a>
                        </li>
                        <li class="nav-item">
