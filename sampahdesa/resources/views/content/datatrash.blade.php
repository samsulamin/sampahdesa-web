...
<div class="row">
    ...
    <div class="col-sm-10">
        <div class="card">
            <div class="card-header bg-dark text-white">
                <h7 class="float-left">Data Desa Terhapus</h7>
                <div class="float-right">
                    <button type="button" class="btn btn-outline-success btn-sm" data-toggle="modal" data-target="#staticBackdrop">
                        <i class='fas fa-plus'></i> Tambah Data
                    </button>
                    |
                    <a href="{{url('datadesa')}}" class="btn btn-outline-primary btn-sm">
                        <i class='fas fa-box-open'></i> Data Desa
                    </a>
                </div>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{url('datadesa/restore/'.$d->id)}}" class="btn btn-outline-warning btn-sm"><i class='fas fa-trash-restore'></i></a>
                                </td>
                            </tr>
    						@endforeach
                        </tbody>
