        ...
        <div class="card-deck">
            <div class="slide-up four col">
                <div class="box shadow bg-light">
                    ...
                    <div class="overlay">
                        <div class="container">
                            <a href="{{url('/datadesa')}}" class="btn btn-fix text-center" aria-hidden="true">
            ...
            {{--<div class="slide-up four col">
                <div class="box shadow bg-light">
                    ...
                    <div class="overlay">
                        <div class="container">
                            <a href="{{url('/notifikasi')}}" class="btn btn-fix text-center" aria-hidden="true">
            ...
            <div class="slide-up four col">
                <div class="box shadow bg-light">
                    ...
                    <div class="overlay">
                        <div class="container">
                            <a href="{{url('/laporan')}}" class="btn btn-fix text-center" aria-hidden="true">
            ...
            <div class="slide-up four col">
                <div class="box shadow bg-light">
                    ...
                    <div class="overlay">
                        <div class="container">
                            <a href="{{url('/about')}}" class="btn btn-fix text-center" aria-hidden="true">
